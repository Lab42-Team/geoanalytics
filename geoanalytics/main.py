...
if __name__ == '__main__':
    ...
    # result = ggu.identify_fire(fires_dict)
    ...
    # result = ggu.delete_fire(fires_dict, not_fires_dict)
    # gp.save_new_csv_file(result)
    ...
    # result = ggu.delete_fire_by_locality(fires_dict, locality_dict)
    ...
    # result = ggu.delete_fire_by_forest_district(fires_dict, forest_districts_dict)
